...
%\multirow{2}{*}{\textbf{CPU}} & \multirow{2}{*}{\textbf{ASM opt.}} & \multicolumn{2}{c|}{\textbf{Footprint (kB)}} & \multicolumn{2}{c|}{\textbf{Clock Cycles}} \\ \cline{3-6} 
%                     &            & \textbf{Flash} & \textbf{RAM} & \textbf{Handshake} & \textbf{Payload} \\ \hline
%\multirow{2}{*}{M0+} &     --     &          6,192 &              &        398,918,083 &          517,536 \\ \cline{2-6} 
%                     & \checkmark &         23,892 &              &         17,807,320 &          247,515 \\ \hline
%\multirow{2}{*}{M4}  &     --     &          6,046 &              &         89,824,263 &          347,560 \\ \cline{2-6} 
%                     & \checkmark &         15,894 &              &          2,077,886 &          129,143 \\ \hline
\end{tabular}
...
Strobe forces permutations for operations involving the network, this is to make sure that previous operations are absorbed prior to involve new sensitive operations. To model this in Tamarin Prover we call the \mintinline{python}{'sponge()'} function at this point in time.\\
